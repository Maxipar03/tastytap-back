...
import { UserValidationDao, UserValidationDB } from "../types/account-verification.types";
import { userValidateMongoDao } from "../dao/mongodb/account-verification.dao";
import { userMongoDao } from "../dao/mongodb/user.dao";
import { BadRequestError } from "../utils/custom-error.utils";

export default class UserValidationsService {
