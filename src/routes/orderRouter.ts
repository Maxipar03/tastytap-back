...
router.put("/:orderId/items/:itemId/status", verifyTokenUser, checkRole(["waiter", "admin", "chef"]), validateJoi( validateItemAndTableOrder, "params" ), orderController.updateStatusItems);
