...
router.post("/invite-employee", verifyTokenUser, checkRole("admin"), validateJoi(validateSendInvitation, "body"), restaurantInvitationController.sendInvitationEmployee);
